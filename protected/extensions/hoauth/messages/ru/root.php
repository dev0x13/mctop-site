...
return array(
    ...
    'Please specify your nickname and email to end with registration.' => 'Пожалуйста, укажите имя пользователя и email, чтобы завершить регистрацию.',
    'Please specify your nickname to end with registration.' => 'Пожалуйста, укажите имя пользователя, чтобы завершить регистрацию.',
    'Please specify your email to end with registration.' => 'Пожалуйста, укажите Ваш email, чтобы завершить регистрацию.',
