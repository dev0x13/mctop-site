...
class Socials extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('name, secretkey', 'required'),
            array('name, secretkey', 'length', 'max' => 255),
            // The following rule is used by search().
            array('id, name, secretkey', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'usersSocialLogins' => array(self::HAS_MANY, 'UsersSocialLogins', 'system'),
        );
    }
    ...
    {
        return Socials::model()->find('name=:name', array(':name' => $name));
    }
}
