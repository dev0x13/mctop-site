<?php $this->pageTitle = ' - ' . (Yii::app()->language == 'en') ? $english_post->title : $post->title; ?>
...
<div class="post">
    ...
    <div class="title">
        <?php echo (Yii::app()->language == 'en') ? $english_post->title : $post->title; ?>
        <div class="author">
    ...
    <div class="full">
        <?php echo (Yii::app()->language == 'en') ? $english_post->full : $post->full; ?>
    </div>
